...
class OtlkMonitor(MonitorBase):
    logger = logging.getLogger(__name__)

    def __init__(self,
                 symbol = "OTLK",
                 press_release_url = "https://ir.outlooktherapeutics.com/news-and-events/press-releases",
                 ):
    ...
    def fetch_news_articles(self, driver=None):
        ...
        articles = WebDriverWait(driver, 10).until(
            EC.presence_of_all_elements_located((
                By.XPATH,
                "//div[@class='nir-widget--news-table']/table/tbody/tr"
            )))
